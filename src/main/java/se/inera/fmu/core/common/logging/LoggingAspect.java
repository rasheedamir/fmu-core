...
/**
 * Aspect for logging execution of service, domain and repository Spring components.
 */
@Aspect
public class LoggingAspect {
    ...
    @Pointcut("within(se.inera.fmu.core.domain..*) || within(se.inera.fmu.core.application.impl..*)")
