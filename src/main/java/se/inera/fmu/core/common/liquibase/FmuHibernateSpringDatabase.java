 ...
 * @author Rasheed
 */
public class FmuHibernateSpringDatabase extends HibernateSpringDatabase {

    private Logger log = LoggerFactory.getLogger(this.getClass());

    public FmuHibernateSpringDatabase(String catalog, String schema) {
